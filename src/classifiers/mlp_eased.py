...
from src.utils.preprocess import load_easy
...
def grid_search():
    ...
    print(report)
    dump(best_est, "./data/best-mlp-eased.joblib")
    ...
    plt.savefig("./plots/MLP/best-MLP-eased.png")
    ...
    curve_plot.savefig("./plots/MLP/best-curve-eased.png")
